...
public class InventorChimpumUpdateService implements AbstractUpdateService<Inventor,Chimpum>{
	...
	public void validate(final Request<Chimpum> request, final Chimpum entity, final Errors errors) {
		...
		if(!errors.hasErrors("code")) {
			...
			final Chimpum chimpum = this.chimpumRepo.findChimpumById(entity.getId());
            errors.state(request, chimpum.getCode().equals(entity.getCode()), "code", "inventor.chimpum.form.error.codeChanged");
